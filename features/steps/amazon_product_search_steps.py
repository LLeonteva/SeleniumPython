...
SEARCH_INFO_BAR = (By.XPATH, "//span[@data-component-type='s-result-info-bar']/div")
...
def verify_found_result_text(context, search_world):
    result_msg = context.driver.find_element(*SEARCH_INFO_BAR).text
    # print(result_msg)
